export const ita = {
    ...
    form:{
        ...
        error: `Si è verificato un errore durante l'invio del messaggio. Per favore riprovi`,
        emptyField: 'Deve compilare tutti i campi del modulo'
    },
    filteredBooks:{
        all: 'Tutte le opere',
    ...
    galleryImages:[
        ...
        },
        {
            ...
            photos:[
               {
                   id: 1,
                   text: 'A Copenaghen (Danimarca) ammirando La Sirenetta, scultura in bronzo simbolo della città, ispirata al racconto omonimo di Hans Christian Andersen.                   '
               },
               {
                   id: 2,
                   text: 'A Cartagena de India (Colombia), davanti al monumento di "el pibe" Valderano, uno dei più prestigiosi calciatori dell’America Latina di tutti i tempi.'
               },
               {
                   id: 3,
                   text: 'Nelle rovine di Efeso in Turchia, uno dei principali gioielli dell’umanità. Situate sul mar Egeo sono arrivate sino a noi in ottimo stato di conservazione.'
               },
               {
                   id: 4,
                   text: 'A Madrid (Spagna) in visita allo Stadio Bernabeu e il Museo del Real Madrid. Uno spettacolare scenario in cui si sono esibite le squadre di calcio più importanti e dove l’Italia ha vinto la Coppa del Mondo nel 1982.'
               },
               {
                   id: 5,
                   text: 'Passeggiando in una delle bellissime e tradizionali stradine di Tallin, capitale dell’Estonia, che conserva intatto il suo incanto medievale e rinascimentale.'
               },
               {
                   id: 6,
                   text: 'A Veracruz, Messico, per ricevere il Trofeo “Premio Sapientiae” all’Eccellenza Educativa a nome dell’Istituto Universitario Tecnologico Amerigo Vespucci di Caracas, in cui per alcuni anni, dopo il pensionamento nella Università Centrale di Caracas, ho svolto mansioni di Direttore Accademico.'
               },
               {
                   id: 7,
               ...
               {
                   id: 8,
                   text: 'Nel Cairo (Egitto). Sullo sfondo la Sfinge e le Piramidi. Uno dei miei viaggi più emozionanti che mi hanno permesso, inoltre, di percorrere un buon tratto del Nilo, il fiume storico che ha ispirato tantissimi miti e leggende.'
               },
               {
                   id: 9,
               ...
               {
                   id: 10,
                   text: 'A San Pietroburgo (Russia). Alle mie spalle l’imponente Palazzo Reale, uno dei monumenti storici più visitati al mondo.'
               },
               {
                   id: 11,
                   text: 'All’entrata della Sagrada Familia, la colossale Basilica ideata dall’architetto Antoni Gaudi nel centro di Barcellona. È uno dei monumenti più visitati della Spagna, insieme al Museo del Prado.'
               },
               {
                   id: 12,
                   text: 'Nel Museo Botero di Bogotà (Colombia). Situato nel centro storico della capitale colombiana custodisce una ricca collezione di opere donate dallo stesso Botero.'
               },
               {
                   id: 13,
               ...
               {
                   id: 16,
                   text: 'Nel Glaciale Perito Moreno, uno dei più spettacolari al mondo, situato nel dipartimento Lago Argentino della provincia di Santa Cruz, nel sud-ovest dell’Argentina, nella regione della Patagonia.'
               },
               {
                   id: 17,
               ...
               {
                   id:20,
                   text: 'Isola di Aruba. Nel sottomarino turistico osservando la bellezza dei coralli e della fauna marina del mar dei Caraibi.'
               },
               {
                   id:21,
