export const es = {
  ...
  form: {
    ...
    error:
      "Ha ocurrido un error envíando su mensaje. Por favor, intente de nuevo",
  ...
  about: {
    ...
    subtitle: "Sobre él",
    description: [
      "El 3 de Julio de 1946, de Giuseppe Castelli y María Morgante. Se gradúa en la Universidad de Bari en Idiomas Modernos y en 1970 regresa a Venezuela donde había llegado la primera vez en 1957 junto con sus hermanos Nina y Giovanni para reunirse con sus padres emigrados a este país en el lejano 1950.",
  ...
  interview: {
    ambassador: {
      title:
        'Entrevista RAI TG Molise en ocasión de recibir la honorificencia de Embajador de "Molisanos" en el mundo',
      text:
        "El periodista de RAI TG Molise (Cb-Italia), además de preguntas acerca de la situación social y política de Venezuela, y del modo de vida de los “molisani” allí residentes, también se detuvo en las actividades literarias y de investigación de Michele Castelli, haciendo particular énfasis en sus estudios dedicados al dialecto de su pueblo, Santa Croce di Magliano.",
    },
    alDescubierto: {
  ...
  galleryImages: [
    {
      ...
      photos: [
        ...
        },
        {
          id: 4,
          text:
            'El Concejal Nicolangelo Licursi lee acuerdo de la Junta Administrativa del Municipio de Santa Croce di Magliano mediante el cual se adhiere oficialmente al homenaje propuesto por el Liceo "Raffaele Capriglione"',
        },
        {
          id: 5,
          text:
            "El Maestro Roberto Di Carlo con su mágica trombeta nos dedicó varias piezas de su repertorio cerrando el acto con broche de oro",
        },
        {
          id: 6,
          text:
    ...
    },
    {
      ...
      photos: [
        ...
        },
        {
          id: 4,
          text:
            "1957. Año de mi salida para Venezuela con mis hermanos Nina y Giovanni para reunirnos con nuestros padres",
        },
        {
          id: 5,
          text:
            "1964. En uno de mis múltiples viajes entre Venezuela e Italia. Aquí con mi primo Michele Morgante en la cubierta del barco Sorrento.",
        },
        {
          id: 6,
          text:
      ...
      photos: [
        {
          id: 1,
          text:
            "En Copenhague (Dinamarca) admirando La Sirenita, escultura en bronce símbolo de la ciudad, inspirada en el cuento homónimo de Hans Christian Andersen.",
        },
        {
          id: 2,
          text:
            'En Cartagena de India (Colombia), delante del monumento de "el pibe" Valderano, uno de los futbolistas más reconocidos de América Latina de todos los tiempos.',
        },
        {
          id: 3,
          text:
            "En las ruinas de Éfeso en Turquía, una de las joyas de la Humanidad. Situadas a orillas del mar Egeo, han llegado hasta nosotros en muy buen estado de conservación.",
        },
        {
          id: 4,
          text:
            "En Madrid (España) visitando el Estadio Bernabeu y el Museo del Real Madrid. Un espectacular escenario en el que se han exhibido los equipos de fútbol más importantes, y en el que Italia ganó la Copa del Mundo en 1982.",
        },
        {
          id: 5,
          text:
            "De paseo en una de las lindas y tradicionales callejuelas de Tallinn, capital de Estonia, que mantiene intacto en buena medida todo su encanto medieval y renacentista.",
        },
        {
          id: 6,
          text:
            "En Veracruz, México, para recibir el Trofeo “Premio Sapientiae” a la Excelencia Educativa en nombre del Instituto Universitario Tecnológico Américo Vespucio de Caracas, en donde por algunos años, luego de la jubilación en la UCV, me desempeñé como Director Académico.",
        },
        {
          id: 7,
          text:
            "En Santa Croce di Magliano (Italia) en el frente de la casa en la que nació Raffaele Capriglione, médico ilustre, poeta dialectal y dibujante excepcional cuya obra fui uno de los primeros en estudiar.",
        },
        {
          id: 8,
          text:
            "En El Cairo (Egipto). Al fondo la Esfinge y las Pirámides. Uno de mis viajes más emotivos que me llevaron, además, a recorrer buen trayecto del Nilo, el río histórico inspiración de muchos mitos y leyendas.",
        },
        {
          id: 9,
        ...
        },
        {
          id: 10,
          text:
            "En San Petersburgo (Rusia). A mis espaldas el imponente Palacio Real, uno de los monumentos históricos más visitados en el mundo.",
        },
        {
          id: 11,
          text:
            "En la entrada de la Sagrada Familia, la colosal catedral católica ideada por el arquitecto Antoni Gaudi en el Centro de Barcelona. Es uno de los monumentos más visitados de España, junto al Museo del Prado.",
        },
        {
          id: 12,
          text:
            "En el Museo Botero de Bogotá (Colombia). Situado en el centro histórico de la capital colombiana alberga una gran colección de obras donadas por el mismo artista Botero.",
        },
        {
          id: 13,
          text:
            "En Londres (Inglaterra) con Elba. A nuestras espaldas el majestuoso Big Ben, símbolo de la ciudad, con cuyo nombre se conoce a la gran campana del reloj situada en el lado noroeste del Palacio de Westminster, la sede del Parlamento del Reino Unido.",
        },
        {
          id: 14,
          text:
            "Con Elba en Casablanca (Marruecos), frente a la imponente Mezquita de Hassan, segundo monarca del país desde que el país recuperó su independencia tras el periodo del Protectorado Francés.",
        },
        {
          id: 15,
          text:
            'En Berlín (Alemania) visitando el "muro de la vergüenza" que formó parte de la frontera de seguridad interalemana desde el 13 de agosto de 1961 hasta el 9 de noviembre de 1989 cuando fue abatido.                   ',
        },
        {
          id: 16,
          text:
            "En el Glaciar Perito Moreno, uno de los más espectaculares del mundo, ubicado en el departamento Lago Argentino de la provincia de Santa Cruz, en el sudoeste de la Argentina, en la región de la Patagonia.",
        },
        {
          id: 17,
          text:
            "Visitando la Piramide de Chichén Itzá en la Península de Yucatán (México), construida en el siglo XII d. C. por los mayas itzaes en su capital, la ciudad de Chichén Itzá, fundada en el siglo VI d. C.",
        },
        {
          id: 18,
          text:
            "En la fachada de la Catedral de Orvieto, una de las más grandes de Italia. En ocasión del Congreso Mundial de literatura alternativa, realizado en esa ciudad.",
        },
        {
          id: 19,
          text:
            "De visita en el Camp Nou de Barcelona (España), estadio de uno de los clubes de fútbol más conocido del mundo fundado el 29 de noviembre de 1899 y registrado oficialmente el 5 de enero de 1903.",
        },
        {
          id: 20,
          text:
            "Isla de Aruba. En el submarino turístico observando la belleza de los corales y de la fauna marina del Caribe.",
        },
        {
          id: 21,
          text:
